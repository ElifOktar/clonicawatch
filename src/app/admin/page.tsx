        ...
        <div className="bg-bg-elev border border-line rounded-xl p-5">
          ...
          <div className="space-y-3">
            ...
            >
              <span className="text-ink-muted text-xl">&#9881;</span>
              <div>
                <div className="text-sm font-medium">Promosyon Bannerlari</div>
                <div className="text-xs text-ink-muted">Ana sayfa slider gorsellerini yonet</div>
              </div>
            </Link>
            <Link
              href="/admin/users"
            ...
            >
              <span className="text-ink-muted text-xl">&#9775;</span>
              <div>
                <div className="text-sm font-medium">Kullanicilar</div>
                <div className="text-xs text-ink-muted">Kayitli kullanicilari gor</div>
              </div>
            </Link>
            <Link
              href="/admin/blog/new"
