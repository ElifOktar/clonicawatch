    ...
    <div className="group relative">
      ...
      {p.stock_status !== "Sold Out" && (
        <button
          ...
          className={`absolute bottom-4 right-4 w-10 h-10 rounded-full flex items-center justify-center transition-all duration-200 shadow-lg ${
            cartAdded
              ? "bg-green-500 text-white scale-110"
              : "bg-gold/90 text-[#0a0e17] hover:bg-gold hover:scale-110"
          }`}
          title="Add to Cart"
